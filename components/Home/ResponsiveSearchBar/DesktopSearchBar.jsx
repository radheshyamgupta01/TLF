...
const DesktopSearchBar = ({
  ...
  return (
    <div className="hidden lg:flex">
      {/* Location Input */}
      <div className="flex items-center px-6 py-4 border-r border-slate-200 flex-1">
      ...
      {/* Property Type Input */}
      <div className="flex items-center px-6 py-4 border-r border-slate-200 flex-1">
        <Home className="w-5 h-5 text-emerald-500 mr-3 flex-shrink-0" />
        <div className="flex flex-col w-full">
          <label className="text-xs text-slate-500 mb-1">Property Type</label>
          <select
      ...
      <button
        ...
        className="bg-gradient-to-r from-blue-500 to-teal-500 text-white px-8 py-4 rounded-r-2xl hover:from-blue-600 hover:to-teal-600 transition-all transform hover:scale-105 shadow-lg flex-shrink-0"
      >
