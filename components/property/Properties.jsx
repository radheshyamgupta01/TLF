...
export default function Properties({ property, isFavorite, setIsFavorite }) {
  // console.log(property);

  return (
    <div className="flex-none w-full md:w-70 bg-white rounded-xl border-slate-200 shadow overflow-hidden hover:shadow-2xl transition-all duration-300 group/card">
      <div className="relative">
        ...
        <button
          onClick={() => setIsFavorite(property.id)}
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-start mb-3">
          <h3 className="text-md line-clamp-2 font-bold text-gray-900 group-hover/card:text-blue-600 transition-colors">
            {property.title}
          </h3>
        </div>
